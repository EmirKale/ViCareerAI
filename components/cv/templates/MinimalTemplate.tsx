...
const styles = StyleSheet.create({
    ...
    name: { fontSize: 28, fontFamily: 'Roboto-Bold', letterSpacing: 1, marginBottom: 5 },
    ...
    sectionTitle: { fontSize: 11, fontFamily: 'Roboto-Bold', borderBottom: '1pt solid #E5E7EB', paddingBottom: 5, marginBottom: 10, textTransform: 'uppercase', letterSpacing: 1, color: '#374151' },
    ...
    itemTitle: { fontSize: 10, fontFamily: 'Roboto-Bold', color: '#111827' },
